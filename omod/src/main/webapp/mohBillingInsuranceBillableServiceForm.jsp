...
<a href="insurance.list"><spring:message code="mohbilling.insurance.current" /></a> &nbsp;&nbsp;<a href="billableService.list?insuranceId=${insurance.insuranceId}">${insurance.name} <spring:message code="@MODULE_ID@.insurance.service.category" /></a>
<br/><br/>
